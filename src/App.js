  ...
  render() {
    ...
    return (
      <div>
        ...
        <div className={ styles.boxBranco }>
          <Form
            cardName={ cardName }
        ...
        <section>
          <h2 className={ styles.todasCartas }>Todas as cartas</h2>
          <div className={ styles.filtro }>
            <h4 className={ styles.filtroBusca }>Filtros de busca:</h4>
            <input
            ...
            <label className={ styles.checked } htmlFor="trunfoFilter">
              Super Trunfo
              <input
                id="trunfoFilter"
                type="checkbox"
